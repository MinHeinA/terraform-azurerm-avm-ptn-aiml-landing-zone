...
- 'virtual_network_integration' - (Optional) Virtual network integration configuration.
  ...
  For Basic, Standard, and Consumption SKUs: virtual_network_integration is not supported and will be ignored.
